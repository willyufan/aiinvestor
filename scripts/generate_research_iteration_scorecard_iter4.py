...
TRACKED_PAYLOAD_REFRESHED: set[str] = {
    "core_explore_80_20_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal28_leader80_coverage_penalty_risk06_cap04_exit74_signal_quality_v4",
}
...
def make_event_card() -> dict[str, Any]:
    event_path = A_DIR / "event_theme_backtest_entry_ai_datacenter_power_grid_202607_v0_path4_capacity_v2_20260829_mature.json"
    ...
    return {
        ...
        "decision": "keep_watch",
        "hypothesis": "相对 Path4 capacity-v2 观察位复核已审计冻结数据中心电力篮子的成熟期，预期 20/40/60D 保持正收益且低 overlap。",
...
def main() -> None:
    ...
    payload = {
        ...
        "budget_note": "A股 12 个、HK 21 个五窗口 security/base ids，加 1 个 Path5 事件篮子，共 34 卡；coverage 无阻塞，显式固定 2026-08-28 离线端点，证券实验总量 33 个并覆盖全部 12 条目标 path；HK Path3 v37 未注册后以 v38 替补完成。",
    ...
    output = A_DIR / "research_iteration_scorecard_20260829.json"
