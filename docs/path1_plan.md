...
- Path1 主线与 core_multifactor 分别确认；多因子代码覆盖目标仍为64/64，本轮无 active evict/archive。
- `core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_6_1__port_weekly_exposure_buffered_asym13` 对 `core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907`：`reject`；since_2020_01 CAGR差-19.92pp、MaxDD差+5.05pp、Sharpe差-0.45；since_2023_01 CAGR差-6.74pp、MaxDD差+4.86pp、Sharpe差-0.15；2026 CAGR -1.81%。触发中窗稳定性护栏：since_2020_01:cagr,since_2020_01:sharpe_ratio,since_2023_01:cagr
- `core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_signal_cashguard_risk16_reconfirm` 对 `core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907`：`reject`；since_2020_01 CAGR差-18.31pp、MaxDD差+10.72pp、Sharpe差-0.39；since_2023_01 CAGR差-8.44pp、MaxDD差+4.35pp、Sharpe差-0.14；2026 CAGR +3.65%。触发中窗稳定性护栏：since_2020_01:cagr,since_2020_01:sharpe_ratio,since_2023_01:cagr

### 本轮候选 ID 与命令

- 本轮 Path1/3/4 六个候选与参照的五窗口批次：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-25 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_signal_cashguard_risk16_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap40_hold8_turn02_exit98_risk08_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly,core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk10_cap06_exit62_lowturn,core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn --comparison-csv /private/tmp/ashare_candidate_20260926.csv`。
- 本轮追加五窗口确认：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-25 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_6_1__port_weekly_exposure_buffered_asym13,core_explore_70_30_equal_weight_winner_core__aggr_03_97_prom3_core_6_1_liqmom_elastic_biweekly_risk22_exit42_cap18_cost_guard_v35_lowturn --comparison-csv /private/tmp/ashare_extra_candidate_20260926.csv`。
...
- 上一轮 core_multifactor risk14 对正式 robust 的中窗 CAGR 明显退化，reject。
- `core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_6_1__port_weekly_exposure_buffered` 对 `core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907`：`reject`；2020/2023 CAGR 差 -18.37/-6.72 个百分点，MaxDD 差 +5.54/+5.93 个百分点，Sharpe 差 -0.42/-0.16，2026 CAGR +1.89%。修正为 core_explore_seed 后五窗复核：2020/2023收益大幅退化，2025也未跑赢，快筛优势不成立。
- `core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_cashguard_risk16_reconfirm` 对 `core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907`：`reject`；2020/2023 CAGR 差 -20.68/-10.31 个百分点，MaxDD 差 +10.04/+8.19 个百分点，Sharpe 差 -0.45/-0.20，2026 CAGR +14.77%。触发中窗稳定性护栏：since_2020_01:cagr,since_2020_01:sharpe,since_2023_01:cagr
- core_multifactor 代码实际覆盖 64/64；本轮 risk16 确认触发中窗护栏，不进入 active 晋级池。Path1 主线依据 winner_only_pass 的 clear 信号实跑 weekly_exposure_buffered 五窗确认，结果按 scorecard 判定。
...
- 本轮执行：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-24 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_6_1__port_weekly_exposure_buffered,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_cashguard_risk16_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907`。
...
- `risk20_reconfirm` 相对 breadth robust 的 2020/2023 CAGR 下降 `3.20/3.45pp`，均命中稳定性护栏，判 `reject`；2025 CAGR 仅提高 `0.64pp`。winner/robust/tracked 不变，无 evict/archive。
- `core_multifactor` 保持代码实际 `64/64` 全覆盖；本轮 Path2 blocker 已占20个 base IDs，未新增该子组参数，不能以 winner-only 代替正式回测。

### 本轮候选 ID 与命令

- 候选 `core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`；参照 `core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-16 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom8_sat_three_stage_buffered_cost_guard_risk20_breadth_v20260907`；scorecard：`results/research/a_share/research_iteration_scorecard_20260917_manual.json`。

### 下一轮 focus 与第一条命令

- `satellite_risk_cost` 已连续确认 risk16/18/20 非 breadth 形态失稳；下一轮切到 `core_multifactor` signal-cashguard 边界。
- 第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-16 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cashguard_risk16_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cashguard_risk18_reconfirm`。

### Focus 候选池

- `satellite_risk_cost`：breadth-v20260907、risk20-reconfirm；`core_multifactor`：signal-cashguard-risk16、signal-cashguard-risk18。
- `holding_shape`：share12/88、share15/85；`weekly_exposure_path`：buffered-asym13、buffered。
...
- 上轮 core_multifactor risk10/risk16 因 2020/2023 收益破坏而 `reject`，risk20 主线保持 `promote`；weekly-exposure 与 holding-shape 转为本轮竞争重点。

### 本轮候选 ID 与命令

- 五窗实跑 `...aggr_10_90_prom6__port_weekly_exposure_buffered_asym13`、`...share_15_85_hold_4_6__sat_three_stage_buffered_asym13`、core_multifactor `...growth_lowvol_signal_quality_gate_cashguard_risk10_reconfirm` 与主线 `...risk20_reconfirm`。完整命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-03 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_10_90_prom6__port_weekly_exposure_buffered_asym13,core_explore_80_20_total_mv_winner_core__share_15_85_hold_4_6__sat_three_stage_buffered_asym13,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_lowvol_signal_quality_gate_cashguard_risk10_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
- `share15` 相对原 2023 winner `share12` 的 CAGR/Sharpe 提高 `0.34pp/0.007`，五窗无护栏且换手略降，`promote` 并成为新 2023-window winner；risk20 五窗确认 `promote` robust 主线。weekly-exposure 实际落到 `growth_elastic`，且相对 Path2 v63 的 2023 MaxDD 恶化超过 `5pp`，按错路由 `reject`。
- core_multifactor：risk10 相对 risk20 的 2020 CAGR/Sharpe下降 `18.21pp/0.438`、2023 CAGR下降 `7.09pp`，`reject`。无 evict/archive；tracked payload 仅同步 2023-window winner。

### 下一轮 focus 提示

- `core_multifactor_coverage` 试 risk08 风险边界，`weekly_exposure_path` 只保留确认过 `core_explore_seed` 路由的 share12-port。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-03 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_lowvol_signal_quality_gate_cashguard_risk08_reconfirm,core_explore_80_20_total_mv_winner_core__share_12_88_hold_4_6__port_weekly_exposure_buffered_asym13,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：growth-lowvol-risk08、risk20 主线；`weekly_exposure_path`：share12-port-weekly-asym13、aggr08-port-weekly-buffered；`satellite_defense`：share15-satellite-asym13、risk20；`holding_shape`：share15、share12。
...
- 主线 `...risk20_reconfirm` 五窗确认继续为 `promote` incumbent；正式 winner/robust/tracked 未变。
- core_multifactor selector 已修复，`profitability_signal_cost_guard` 与 `profitability_lowvol_signal_cost_guard` 均真实落入 `core_explore_seed`。相对 risk20，2020 CAGR 分别下降 `15.75/16.37pp`、Sharpe 下降 `0.368/0.376`，2023 CAGR下降 `7.62/5.91pp`，均触发稳定性护栏并 `reject`。假设“正确路由后能以较浅回撤守住中窗收益”不获支持；无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260901.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cost_guard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_lowvol_signal_cost_guard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
...
- `core_multifactor_coverage` 停止已否定 cost-guard 同形，转验 signal-quality-gate 的 risk12/risk10 边界；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-31 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk12_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk10_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：signal-quality-gate-risk12、signal-quality-gate-risk10；`weekly_exposure_path`：port-weekly-buffered、port-weekly-buffered-asym13；`satellite_defense`：risk18、risk20；`holding_shape`：share22、share24。

## 2026-08-31 迭代：core_multifactor cost-guard 仍发生 selector 路由错位（端点 2026-08-28）

### 上一轮候选与结果摘要

- 主线 `core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm` 五窗口确认，2020/2023/2026 CAGR 为 `26.59%/22.61%/24.20%`，判 `promote` incumbent；正式 Path1 robust/tracked 主体未变。
- core_multifactor：`...quality_profitability_signal_cost_guard_reconfirm` 与 `...quality_profitability_lowvol_signal_cost_guard_reconfirm` 的 only-base-id 实跑仍落入 `growth_elastic`，不是 `core_explore_seed`；两条相对 risk20 的 2020 CAGR 均下降约 `30.7pp`、2026 CAGR约 `-15.8%`，同时因路由不可比判 `reject`。假设“cost-guard 可在正确 Path1 池内守住中窗并降换手”未被有效验证；需先修 selector 路由，无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260831.json`。

### 本轮候选 ID 与命令

- 实跑 IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cost_guard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_lowvol_signal_cost_guard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-28 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_lowvol_signal_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### 下一轮 focus 提示

- `core_multifactor_coverage`：先修复这两条 variant 的 `core_explore_seed` selector 路由，再做同池五窗口确认；未修前不重复解释错池结果。修复后的第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_lowvol_signal_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：profitability-signal-cost-guard、profitability-lowvol-signal-cost-guard；`weekly_exposure_path`：port-weekly-buffered、port-weekly-buffered-asym13；`satellite_defense`：risk18、risk20；`holding_shape`：share22、share24。
...
- 主线：`risk20_reconfirm` 五窗口同端点确认，2020/2023/2026 CAGR 为 `26.59%/22.61%/24.20%`，判 `promote` incumbent；正式 winner/robust/tracked ID 未变。
- core_multifactor：`profitability-signal-risk16` 与 `profitability-growth-risk16` 均正确落入 `core_explore_seed`，但相对 risk20 的 2020 CAGR 分别下降 `15.82/15.45pp`、2023 下降 `7.75/6.71pp`，并命中 CAGR/Sharpe 护栏，均 `reject`。假设“正确路由的 risk16 多因子能用更浅回撤换取不超过3pp的中窗收益损失”不获支持；coverage `64/64`，无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260829.json`。
...
- `core_multifactor_coverage` 停止 risk16 同形，转验 risk14 相邻形态是否继续改善回撤且把 2020/2023 收益损失收窄到3pp内；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cashguard_risk14_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_signal_cashguard_risk14_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：profitability-signal-risk14、profitability-growth-risk14；`signal_quality`：port-buffered-asym13（先修路由）、satellite-buffered-asym13（先修路由）；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk18、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：pulse40-v17、risk20。

## 2026-08-28 迭代：winner-only clear 信号落盘路由否定（端点 2026-08-27）

### 上一轮候选与结果摘要

- 主线：`port_weekly_exposure_buffered_asym13` 与 `sat_three_stage_buffered_asym13` 在 winner-only 内存筛选中是 clear signal，但 only-base-id 落盘均进入 `growth_elastic`，不是 Path1 `core_explore_seed`；相对 risk20 的 2020 CAGR 分别下降 `23.31/26.65pp`，均触发 CAGR/Sharpe 护栏并 `reject`。`risk20_reconfirm` 五窗同端点确认 `promote` incumbent，正式 winner/robust/tracked 未变。
- core_multifactor：coverage 保持 `64/64`；本轮预算优先确认两条 clear signal，未新增正确路由的多因子实跑。假设“clear signal 可直接落盘挑战 Path1 winner”不获支持；无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260828.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7__port_weekly_exposure_buffered_asym13`、`core_explore_80_20_total_mv_winner_core__aggr_10_90_prom6__sat_three_stage_buffered_asym13`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-27 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7__port_weekly_exposure_buffered_asym13,core_explore_80_20_total_mv_winner_core__aggr_10_90_prom6__sat_three_stage_buffered_asym13,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### 下一轮 focus 提示

- `core_multifactor_coverage` 先回到 direction group 中已能落入 `core_explore_seed` 的 risk16 相邻形态，只有 pool 路由正确才判断收益；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cashguard_risk16_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_signal_cashguard_risk16_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：profitability-signal-risk16、profitability-growth-risk16；`signal_quality`：port-buffered-asym13（修路由后）、satellite-buffered-asym13（修路由后）；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk18、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：pulse40-v17、risk20。

## 2026-08-27 迭代：core_multifactor 路由错位与强锚确认（端点 2026-08-26）

### 上一轮候选与结果摘要

- 主线：`risk20_reconfirm` 五窗口同端点确认，2020/2023/2026 CAGR 为 `26.14%/21.63%/19.74%`，判 `promote` incumbent；正式 winner/robust/tracked 主体未变。
- core_multifactor：`profitability_signal_cost` 与 `value_lowvol_industry_cost` 的 only-base-id 落盘仍路由到 `growth_elastic`，不是 Path1 `core_explore_seed`；相对 risk20 的 2020 CAGR 分别下降 `30.30/30.45pp`，均触发 CAGR/Sharpe 护栏并 `reject`。假设“已注册成本守门形态可正确路由并守住中窗收益”不获支持；无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260827.json`。
...
- `core_multifactor_coverage` 不再复跑这两条 route-mismatch 形态；本轮证券预算已用满后，winner-only 新报出 `port_weekly_exposure_buffered_asym13` 与 `sat_three_stage_buffered_asym13` clear signal，下一轮先与 risk20 做五窗精确确认，再回到已正确路由的 core_multifactor 相邻形态。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7__port_weekly_exposure_buffered_asym13,core_explore_80_20_total_mv_winner_core__aggr_10_90_prom6__sat_three_stage_buffered_asym13,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：profitability-signal-cashguard-risk18、growth-lowvol-risk06；`signal_quality`：port-buffered-asym13、satellite-buffered-asym13；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk10、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：cash-off-dd-guard50、risk20。
...
- 主线：`risk20_reconfirm` 五窗口同端点确认，2020/2023/2026 CAGR 为 `26.06%/21.82%/20.05%`，判 `promote` incumbent；正式 Path1 winner/robust 主体未被本轮挑战者替换。`winner_only_pass.py` exit `2` 仅表示 raw clear signal，未替代本轮同池五窗口确认。
- core_multifactor：`value_lowvol_trend_signal_cashguard_risk20/risk18` 两条请求均实际落入 `growth_elastic`，不是 Path1 `core_explore_seed`；同时相对 risk20 锚的 2020 CAGR 分别下降 `30.30/30.36pp`、Sharpe下降 `0.921/0.926`，按 route mismatch 与稳定性护栏双重 `reject`。假设“提高 value/lowvol/trend 风险边界可守住中窗收益”不获支持；代码覆盖仍为 `64/64`，无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260825.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_signal_cashguard_risk20_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_signal_cashguard_risk18_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
...
- `core_multifactor_coverage` 先用代码 direction group 中不带风险后缀的 exact key 再审计路由，只有 `pool_id=core_explore_seed` 才继续判断；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_industry_signal_cashguard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：value-lowvol-trend-cost、value-lowvol-industry-signal；`signal_quality`：port-buffered-asym13、satellite-buffered-asym13；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk10、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：cash-off-dd-guard50、risk20。

## 2026-08-24 迭代：core_multifactor 正确路由后的中窗再否定（端点 2026-08-21）

### 上一轮候选与结果摘要

- 主线：`cash_off__sat_three_stage_risk` 实跑仍落入 `growth_elastic`，与 Path1 `core_explore_seed` 参考池不一致，按 route mismatch `reject`；正式 window winner/robust/tracked 未变。
- core_multifactor：`quality_profitability_signal_cashguard_risk18` 与 `growth_lowvol...risk06` 已正确落入 `core_explore_seed`，验证了路由修复；但相对 `risk20_reconfirm` 的 2020 CAGR 分别下降 `15.49/17.30pp`，2023下降 `8.08/11.85pp`，均触发护栏并 `reject`。假设“正确路由后可用更浅回撤换取不超过3pp中窗收益损失”不获支持；代码覆盖仍为 `64/64`，无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260824.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_signal_cashguard_risk18_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_lowvol_signal_quality_gate_cashguard_risk06_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cash_off__sat_three_stage_risk`。
...
- `core_multifactor_coverage` 转向 value/lowvol/trend 的高风险边界，检验风险20/18能否保住中窗收益；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_signal_cashguard_risk20_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_signal_cashguard_risk18_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：value-lowvol-trend-risk20、value-lowvol-trend-risk18；`signal_quality`：port-buffered-asym13、satellite-buffered-asym13；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk10、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：cash-off-dd-guard50、risk20。
...
- core_multifactor `growth-lowvol-risk08` / `growth-trend-risk06` 相对当前 2020 window winner `risk20_reconfirm` 的 2020 CAGR 分别下降 `16.85/17.16pp`，2023 CAGR下降 `10.43/7.63pp`，均触发稳定性护栏并 `reject`；回撤与换手改善不足以抵消收益损失，停止同形扩参。
- 主线 `risk20_reconfirm` 五窗同窗确认 `promote` incumbent；正式 2020 window winner 仍为 risk20，robust 仍为 risk10。winner-only exit `2` 只表示四个 raw clear signal，未在本轮 33 个证券实验预算内追加精确确认。完整 scorecard：`results/research/a_share/research_iteration_scorecard_20260822.json`；无 evict/archive。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_lowvol_signal_quality_gate_cashguard_risk08_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk06_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-21 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_lowvol_signal_quality_gate_cashguard_risk08_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk06_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### 下一轮 focus 提示

- `core_multifactor_coverage` 已否定 growth-lowvol/trend 的极低风险门槛；下一轮先精确确认 winner-only 的 2020 clear signal与当前 risk20，第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_ramp90__sat_three_stage_buffered_asym13,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cash_off__sat_three_stage_risk,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：quality-profitability-value-lowvol-industry-cost、quality-value-industry-cost；`signal_quality`：ramp90-satellite-asym13、cashoff-satellite-risk；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk10、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：pulse40-v17、risk20。

## 2026-08-21 迭代：core_multifactor 风险梯度再确认（端点 2026-08-20）

### 上一轮候选与结果摘要

- 主线锚 `risk10_reconfirm` 相对当前 robust `risk20_reconfirm` 的 2020 CAGR 下降 `4.60pp`、2023 CAGR下降 `2.15pp`，但仍承担现有窗口角色，判 `keep_watch`。正式 window winner/robust/tracked 与运行前 `HEAD` 一致，无 evict/archive。
- core_multifactor：quality-gate `risk09/risk08` 虽令 2020/2023 MaxDD 分别改善约 `9.70/14.55pp`，但 2020 CAGR下降 `19.20/18.81pp`、2023 CAGR下降 `5.50/7.05pp`，均触发稳定性护栏并 `reject`。假设“进一步降低多因子风险可在守住中窗收益下改善回撤”不获支持；代码覆盖仍为 `64/64`。完整 scorecard：`results/research/a_share/research_iteration_scorecard_20260821.json`。
...
- `core_multifactor_coverage` 停止 quality-gate risk08/09 同形扩参，转验 growth-lowvol 的风险质量门槛；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_lowvol_signal_quality_gate_cashguard_risk08_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk06_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：growth-lowvol-quality-gate-risk08、quality-gate-risk06；`signal_quality`：risk10、risk20；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk10、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：pulse40-v17、risk20。

## 2026-08-20 迭代：core 覆盖与 clear-selector 精确否定（端点 2026-08-19）

### 上一轮候选与结果摘要

- 本轮确认 6 个 Path1 security/base ids。`risk10_reconfirm` 同窗确认 `promote` incumbent；`hold_3_6_ramp90` 的 2020 CAGR 相对 risk10 下降 `7.78pp`，`reject`。core_multifactor 的 `growth-trend-signal-quality-gate-risk10` 在 2020 CAGR/Sharpe 下降 `14.37pp/0.343`，`balanced__sat_weekly_risk` 的 2020/2023 CAGR下降 `10.26/6.76pp`，均 `reject`；core 代码覆盖仍为 `64/64`。
- winner-only 报出的 `risk12_reconfirm` 精确五窗无硬护栏，但 2017/2023 CAGR分别下降 `1.91/2.38pp`，未形成新前沿，`keep_watch`；`cash_off_and__sat...asym13` 实跑落入 `growth_elastic` 且 2020 CAGR下降 `23.22pp`，按 route mismatch `reject`。正式 window winner/robust/tracked ID 未改变，无 evict/archive。完整 scorecard：`results/research/a_share/research_iteration_scorecard_20260820.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_hold_3_6_ramp90`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk10_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk10_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk12_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_core_multifactor_balanced__sat_weekly_risk`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cash_off_and__sat_three_stage_buffered_asym13`。
- 命令类型：两批五窗口 `--only-base-ids` 精确确认；统一前缀为 `AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-19 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids`，后接上述具体 IDs。

### 下一轮 focus 提示

- `core_multifactor_coverage` 停止 balanced overlay 与 quality-gate-risk10 同形扩参，转查相邻 risk09/risk08；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk09_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_quality_gate_cashguard_risk08_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk10_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage`：quality-gate-risk09、quality-gate-risk08；`signal_quality`：risk12、risk10；`weekly_exposure_path`：port-buffered、port-buffered-asym13；`satellite_defense`：risk10、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`crash_resilience`：pulse40-v17、risk10。
...
- 主线复核 `pulse40_1w_v17` 与 `risk20_reconfirm`：2026 CAGR/MaxDD 为 `47.55%/-25.36%` 对 `24.61%/-40.41%`，改善 `22.95pp/15.05pp`；但 2020/2023 CAGR 仍落后 `9.18pp/3.42pp`，因此只作专项 `keep_watch`，不是多窗口 robust。`risk20_reconfirm` 为 incumbent 同窗 `promote`；正式 window winner/robust/tracked 未改变。
- core_multifactor 两条 signal-cashguard 实际仍路由到 `growth_elastic`，2020 CAGR 为 `-3.99%/-3.64%`，相对 risk20 下降约 `30pp`，均 `reject`。假设“value-lowvol 信号现金守门可修复路由并保住中窗”不成立；覆盖保持 `64/64`，无 evict/archive。scorecard：`results/research/a_share/research_iteration_scorecard_20260813.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_industry_signal_cashguard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_signal_cashguard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_risk20_port_fast_crash_pulse40_1w_v17`。
...
- `core_multifactor_coverage` 停止本轮两条 route-mismatch 形态，回查更简单的行业低波/质量价值成本守门。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_lowvol_industry_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_value_industry_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
- `crash_resilience` 只在新端点确认 `pulse40_1w_v17`，不再做同形仓位细分；原因是上一轮膝点已收敛。

### Focus 候选池

- `core_multifactor_coverage` / `signal_quality`：quality-lowvol-industry-cost、quality-value-industry-cost；`crash_resilience`：pulse40-v17、risk20；`weekly_exposure_path`：buffered-asym13、buffered-asym；`satellite_defense`：risk18、risk20。
- `holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`signal_variants`：core-6-1-aggr08、core-6-1-aggr10。

## 2026-08-12 四至六次迭代：暴跌脉冲膝点收敛（端点 2026-08-11）

### 上一轮候选与结果摘要

- 本轮按触发确认、持续期、冷却期、触发阈值和仓位强度连续推进 22 个 Path1 候选。最终 `pulse40_1w_v17` 相对 `pulse55_1w_v3`，2025 CAGR/MaxDD/turnover 为 `57.93%/-24.92%/5.18x` 对 `59.93%/-27.29%/4.73x`；2026 为 `43.64%/-25.36%/6.87x` 对 `39.42%/-27.47%/6.29x`。直接相邻 2025 CAGR 仅降 `2.00pp`，2026 CAGR/MaxDD 改善 `4.22pp/2.11pp`，判定 `promote`，但 official window winner/robust/tracked 同步后未改变。
- `v5/v6/v8/v10/v11` 为 `reject`；等价或被支配的 `v7/v9/v12` 为 `archive`；`v13-v16/v18-v26` 仅 `keep_watch`。最后两组膝点候选未再形成显著前沿，因此停止同形扩参。仅 reject/archive 退出 active，keep_watch 继续保留，历史快照不删除。scorecard：`results/research/a_share/research_iteration_scorecard_20260812_iter4.json`。
- core_multifactor 覆盖仍为 `64/64`，本轮未新增实跑：暴跌脉冲终端定位使实际实验达到 `51` 个 ID，已超 48 软上限；不以 coverage 代替实验。

### 本轮候选 ID 与命令

- 主竞争 IDs：`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_risk20_port_fast_crash_pulse40_1w_v17`、`...pulse55_1w_v3`；完整 v5-v26 均收录在本轮 scorecard。
- 命令类型：五窗口增量 `--only-base-ids`，分批写入 `crash_resilience_strategy_comparison_iter4*.csv`，并以 `AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-11 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_risk20_port_fast_crash_pulse40_1w_v17` 写回主 comparison。

### 下一轮 focus 提示

- `crash_resilience` 同形参数已收敛，下一轮只做跨端点确认或新机制挑战，不继续细分仓位。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_risk20_port_fast_crash_pulse40_1w_v17,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_risk20_port_fast_crash_pulse55_1w_v3,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
- core_multifactor 第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_industry_signal_cashguard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_signal_cashguard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `crash_resilience`：pulse40-v17、pulse55-v3；`crash_signal_quality`：pulse40+breadth45、pulse40+drawdown3；`weekly_exposure_path`：buffered-asym13、buffered-asym；`satellite_defense`：risk18、risk20。
- `core_multifactor_coverage` / `signal_quality`：industry-signal-cashguard、trend-signal-cashguard；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`signal_variants`：core-6-1-aggr08、core-6-1-aggr10。
...
- core_multifactor industry-cost 的 2020/2023/2026 CAGR 为 `-3.82%/14.98%/-11.21%`，且路由到 `growth_elastic`；trend-cost 为 `8.75%/16.77%/9.55%`，相对 risk20 锚的 2020/2023 CAGR 下降 `17.15pp/4.23pp`。两条均命中稳定性护栏，`reject`，假设“value-lowvol 成本守门可保住中窗”不成立。
- 主线 `risk20_reconfirm` 以 2020/2023/2026 CAGR `25.90%/21.01%/21.19%` 同窗确认 `promote` incumbent；core_multifactor 仍为 `64/64`，winner-only 的 clear-improvement 仅作 fast-pass 信号，正式 winner/robust/tracked 未变，无 evict/archive。scorecard：`results/research/a_share/research_iteration_scorecard_20260812_iter2.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_industry_cost_guard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_cost_guard_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-11 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_industry_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`；另运行 `scripts/winner_only_pass.py`。

### 下一轮 focus 提示

- `core_multifactor_coverage` 停止本轮两个 cost-only 形态，转向 value-lowvol 的 industry/trend signal-cashguard，要求 2020 CAGR 不再大幅落后。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-11 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_industry_signal_cashguard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_signal_cashguard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage` / `signal_quality`：value-lowvol-industry-signal-cashguard、value-lowvol-trend-signal-cashguard；`weekly_exposure_path`：buffered-asym13、buffered-asym；`satellite_defense`：risk18、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`signal_variants`：core-6-1-aggr08、core-6-1-aggr10。

## 2026-08-12 迭代记录（端点 2026-08-11）

### 上一轮候选与结果摘要

- core_multifactor `quality_profitability_signal_cost_guard` 与 `quality_profitability_lowvol_signal_cost_guard` 实际路由到 `growth_elastic`，2020/2026 CAGR 分别为 `-3.62%/-13.88%`、`-3.67%/-13.80%`，均 `reject`；本轮假设“质量盈利成本守门可保住 Path1 中窗”不成立。
- 主线 `satellite_cost_guard` 的 2020 CAGR `19.78%`，相对正式 robust `risk20_reconfirm` 的 `25.90%` 下降超过 3pp，`reject`；`risk20_reconfirm` 以 2020/2023/2026 CAGR `25.90%/21.01%/21.19%` 同窗确认 `promote` incumbent。core_multifactor 覆盖 `64/64`，正式 winner/robust/tracked ID 未因挑战者改变，无 evict/archive。
...
- `core_multifactor_coverage` 停止本轮两个 route-mismatch 形态，改查 value-lowvol 的 industry/trend 成本守门并保留正式 robust。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-11 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_industry_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_value_lowvol_trend_cost_guard_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_05_95_prom7_sat_three_stage_buffered_cost_guard_risk20_reconfirm`。

### Focus 候选池

- `core_multifactor_coverage` / `signal_quality`：value-lowvol-industry-cost、value-lowvol-trend-cost；`weekly_exposure_path`：buffered-asym13、buffered-asym；`satellite_defense`：risk18、risk20；`holding_shape`：share22、share24；`promotion_ramp`：prom5、prom7；`signal_variants`：core-6-1-aggr08、core-6-1-aggr10。
...
- 五窗口确认 `...growth_trend_signal_cashguard_risk16_reconfirm`、`...risk14_reconfirm` 与 `...satellite_cost_guard`；实验假设是温和 cashguard 风险档能改善信号质量。前两者 2020/2023/2026 CAGR 为 `9.39%/16.58%/8.34%`、`9.30%/16.70%/7.94%`，相对 satellite 的 `20.24%/22.54%/12.87%` 触发 CAGR 护栏，均 `reject`。
- 主线 satellite-cost 五窗平均 turnover `3.96x`，确认 `promote` incumbent；core_multifactor 无晋级，winner / robust / tracked ID 未变，无 evict。plan 原 `...risk14` 缺 `_reconfirm` 未注册，已用正确 active ID 补跑，不计为实验。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_cashguard_risk16_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_trend_signal_cashguard_risk14_reconfirm`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_satellite_cost_guard`。
- 命令：`.venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids <上述3个ID>`；scorecard：`results/research/a_share/research_iteration_scorecard_20260809_iter2.json`。

### 下一轮 focus 提示

- `signal_quality` 停止 trend-signal risk14/16 同形扩参，改验不含 trend 的 growth-signal cashguard，目标是缩小 2020 CAGR 缺口且不增加回撤。第一条命令：`.venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_signal_cashguard_risk16_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_quality_profitability_growth_signal_cashguard_risk14_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_satellite_cost_guard`。

### Focus 候选池

- `signal_quality` / `core_multifactor`：`...quality_profitability_growth_signal_cashguard_risk16_reconfirm`、`...risk14_reconfirm`；`weekly_exposure_path`：`...__port_weekly_exposure_buffered_asym13`、`...__port_weekly_exposure_asym`。
- `satellite_defense`：`...satellite_cost_guard`、`...sat_three_stage_buffered_cost_guard_risk20_reconfirm`；`holding_shape`：`...share_22_78_hold_2_8_ramp64_cost_guard`、`...share_24_76_hold_2_8_ramp62_cost_guard`。
- `promotion_ramp`：`...aggr_10_90_prom5`、`...aggr_10_90_prom7`；`signal_variants`：`...aggr_08_92_prom6_core_6_1`、`...aggr_10_90_prom6_core_6_1`。
...
- `core_multifactor_coverage` 确认 profitability-growth-signal-cashguard 的 risk16/risk14，并以 satellite-cost robust 同端点比较。两条候选 2020/2023/2026 CAGR 分别为 `10.56%/14.89%/3.56%`、`10.41%/14.91%/3.21%`，相对 robust 的 2020 CAGR 均下降约 `9pp`，判 `reject`；“现金守门可保住中窗”的假设不成立。
- satellite-cost 五窗口全正，2020/2023/2026 CAGR 为 `19.63%/21.21%/7.05%`，确认 `promote` incumbent，不是挑战者替换。core_multifactor coverage 仍完整，无 winner/robust/tracked 变化、无 evict/archive。
...
完整五窗口卡片见 `results/research/a_share/research_iteration_scorecard_20260807_iter2.json`。

### 下一轮 focus 提示

- 最终 guard 仍指向 `core_multifactor_coverage`；下一轮用尚未确认的 quality-gate risk12/risk10 继续补强该方向，验证其能否改善 2023 且不破坏 2020，并保留 satellite-cost robust；第一条命令：
...
- `core_multifactor_coverage`：growth-signal-cashguard-risk16、risk14；`signal_quality`：quality-gate-risk12、risk10。
- `satellite_risk_cost`：sat-risk14、sat-risk12；`holding_shape`：share20-reconfirm、share22；`weekly_exposure_path`：buffered、buffered-asym13。
...
- 主线按 `holding_shape` 同端点确认 share22/share24 与 satellite-cost robust。share22/share24 的 2020/2023/2026 CAGR 分别为 `17.95%/18.89%/7.40%`、`18.07%/18.82%/7.98%`，未触发护栏但未形成跨窗优势，均 `keep_watch`；satellite-cost 为 `19.63%/21.21%/7.05%`，确认 `promote` incumbent，不是挑战者替换。
- `core_multifactor` 子段确认 profitability-industry 与 profitability-growth 简化信号；2020 CAGR 仅 `10.56%/10.73%`，相对 robust 下降约 `9pp`，且 Sharpe 护栏触发，均 `reject`。代码方向组 coverage 保持完整；无 evict/archive，正式 winner/robust/tracked ID 暂未改变。

### 本轮候选 ID 与命令

```bash
AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-06 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__share_22_78_hold_2_8_ramp64_cost_guard,core_explore_80_20_total_mv_winner_core__share_24_76_hold_2_8_ramp62_cost_guard,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_satellite_cost_guard,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_profitability_industry_signal_reconfirm,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_core_multifactor_profitability_growth_signal_reconfirm
```

完整五窗口对比见 `results/research/a_share/research_iteration_scorecard_20260807.json`。

### 下一轮 focus 提示

- 最终 guard focus 为 `holding_shape`；share22/share24 只保留观察，下一轮改验 share20-reconfirm，并保留 satellite-cost robust。目标是 2020/2023 CAGR 差距不超过 `3pp`、2026 非负且降低回撤；第一条命令：
...
- `holding_shape`：share20-reconfirm、share22；`weekly_exposure_path`：buffered、buffered-asym13；`satellite_risk_cost`：risk18、risk20。
- `core_multifactor_coverage`：profitability-growth-signal-cashguard-risk16、risk14；`signal_quality`：quality-growth-signal、quality-lowvol-industry。
...
- 主线以当前强 robust `...aggr_08_92_prom6_satellite_cost_guard` 为同端点对照，确认正式 2017/2020 window winner `risk20_reconfirm`：2020/2023/2026 CAGR 为 `22.96%/15.73%/-9.36%`，中窗仍有效但短窗为负，判 `keep_watch`，不替换 robust。
- `core_multifactor` 子段按 `core_multifactor_coverage` 确认 quality-gate risk09/risk12；两者 2020/2023/2026 CAGR 分别为 `5.98%/14.55%/-10.86%`、`6.06%/14.90%/-10.21%`，相对强 robust 的 2020 稳定性明显破坏，均 `reject`。代码覆盖保持 `64/64`；假设“更严质量门槛可保住中窗并降风险”未获支持。
- weighted 同步后 Path1 robust 刷新为 `...aggr_08_92_prom6_satellite_cost_guard`，正式 window winners 未替换。该 robust 五窗 minCAGR 为正，属于强 incumbent；本轮无 evict/archive。完整 scorecard：`results/research/a_share/research_iteration_scorecard_20260805.json`。
...
- risk09/risk12 quality-gate 同形停止；下一轮改验 profitability/value/lowvol/trend 的 risk18/risk20，目标是在 2020/2023 不触发护栏的前提下降低回撤，并继续与 `satellite_cost_guard` 比较。第一条命令：
...
- `core_multifactor_coverage`：profitability-value-lowvol-trend risk18、risk20；`signal_quality`：quality-gate risk08、risk10。
- `holding_shape`：share22、share24；`satellite_risk_cost`：risk14-reconfirm、risk12-reconfirm；`weekly_exposure_path`：buffered、buffered-asym13。
...
- 主线确认 `sat_three_stage_buffered_cost_guard_risk20_reconfirm`：2020/2023/2026 CAGR 为 `22.97%/15.75%/-9.40%`，中长窗仍具竞争力但短窗为负，判定 `robust_observation`；进入观察位，不是强稳定 winner。
- core_multifactor 子段按 `signal_quality` 确认 lowvol-risk08 与 trend-risk10。两者 2020 CAGR/Sharpe 均显著落后 risk20，且分别命中 2023 CAGR 护栏或 2020 稳定性护栏，均 `reject`。假设“信号质量门槛能修复中窗且降低回撤”未获支持。Path1 未新增 evict/archive，tracked 未因挑战者改变。
...
五窗口 scorecard 见 `results/research/a_share/research_iteration_scorecard_20260804.json`，包含 CAGR、Sharpe、MaxDD、turnover、对照值与 delta。

### 下一轮 focus 提示

- `signal_quality` 不再继续 risk08/risk10 同形扩参，下一轮用 risk09/risk12 边界确认并保留 risk20 对照；第一条命令：
...
- `signal_quality`：trend-signal-risk09、trend-signal-risk12；`core_multifactor_coverage`：profitability-value-lowvol-trend-risk18、profitability-value-lowvol-trend-risk20。
- `holding_shape`：share22、share24；`satellite_risk_cost`：risk16、risk18；`weekly_exposure_path`：`__port_weekly_exposure_buffered`、`__port_weekly_exposure_buffered_asym13`。
