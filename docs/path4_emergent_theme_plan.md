...
- 本轮 `core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap05_exit70_lowturn` 对 `core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn`：`keep_watch`；2020/2023 CAGR 差 -0.28/+1.26pp，MaxDD 差 +0.10/-0.29pp，2026 CAGR -7.33%。中窗未触发阈值，但2026窗口CAGR为负；继续观察。

### 本轮候选 ID 与命令

- 候选及参照五窗口确认：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-25 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap05_exit70_lowturn,core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn`。实验假设：提高主题风险控制并延长退出阈值，预期改善2020/2023最大回撤且保持收益。

### 下一轮 focus 与第一条命令

- 第一条可执行命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-25 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk10_cap06_exit62_lowturn,core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn`。

### Focus 候选池

- `emergent_theme_coverage`：`core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk06_cap05_exit68_lowturn`、`core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap05_exit70_lowturn`。
...
- Path4 保持独立 emergent_theme 池，不并入 Path2；当前弱 robust 仅是观察位。
- 本轮候选 2026 窗口最新持仓为 8 只、总仓位 38.94%；第一大持仓占净值 5.42%，前三大占已投资仓位 39.37%。该单期截面不能证明持续捕捉强主题，下一轮继续检查持仓时间序列与容量。
- `core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk10_cap06_exit62_lowturn` 对 `core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn`：`keep_watch`；since_2020_01 CAGR差+0.41pp、MaxDD差-4.01pp、Sharpe差+0.02；since_2023_01 CAGR差+0.18pp、MaxDD差-3.33pp、Sharpe差+0.00；2026 CAGR -9.37%。中窗未触发硬护栏，但2026收益为负，继续观察。
...
- 上一轮 signal30/risk08/exit66 仅进入 Path4 内部 robust 观察位，2026 为负，不是强稳定 winner。
- `core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk06_cap05_exit68_lowturn` 对 `core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn`：`keep_watch`；2020/2023 CAGR 差 -0.28/+1.26 个百分点，MaxDD 差 +0.10/-0.29 个百分点，Sharpe 差 -0.02/+0.10，2026 CAGR -7.33%。2023收益改善，但2017/2020略退化且2026仍为负；弱路径内部只作风险边界观察。
- 独立 Path4 强主题涌现仍只在观察层；2026 为负，单票集中度与容量尚待核验，未并入 Path2。
- 复核本轮 risk06 候选 2026 窗口最新持仓：8 只、总仓位约 32.39%，第一大持仓占净值约 4.51%（占已投仓位 13.91%），前三大占已投仓位 39.37%；本次仅核验当前截面，尚不能据此排除历史单票驱动或证明持续捕获强行业/龙头，下一轮需查持仓时间序列和容量。
...
- 本轮执行：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-24 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk06_cap05_exit68_lowturn,core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn`。
...
- signal-quality-v4/risk-control-v5 的中窗 MaxDD 恶化超过 10 个百分点，均 reject。
- core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn 对 core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap05_exit70_lowturn：robust_observation；2020/2023 CAGR Δ +0.28/-1.26pp，MaxDD Δ -0.10/+0.29pp，Sharpe Δ +0.02/-0.10，2026 CAGR -6.85%。2020 CAGR仅高0.28个百分点，2023低1.27个百分点，2026同为-6.85%；artifact把候选推入Path4内部2017窗口及robust观察位，但绝对收益弱且近窗亏损，仅作观察。
- Path4 内部 2017-window winner 与 robust 观察位转为本轮候选；2026 仍亏损，**进入观察位，不是强稳定 winner**；2020/2023 winner 不变，无 evict/archive。

### 本轮候选 ID 与命令

- 已实跑：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-23 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk08_cap05_exit66_lowturn,core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap05_exit70_lowturn`。五窗口逐项 CAGR、Sharpe、MaxDD、换手、成本与差值见 `results/research/a_share/research_iteration_scorecard_20260924.json`。
- 假设：将主题信号阈值 29 提到 30、风险仓位 04 到 08、退出 70 到 66，预期增强强主题覆盖和中窗 CAGR，同时避免回撤失控。

### 下一轮 focus 与第一条命令

- `emergent_theme_coverage`：观察 signal30 风险边界，首命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-23 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal30_leader78_coverage_penalty_risk06_cap05_exit68_lowturn,core_explore_90_10_equal_weight_winner_core__aggr_13_87_prom22_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap05_exit70_lowturn`。确认 2023 收益、2026 正收益与单票集中度后才考虑晋级；连续 3 轮无改善归档。
...
- 上轮低换手变体未修复 2026。本轮 `signal_quality_v4` 相对 capacity-v2 的 2020 CAGR 提高 `0.69pp`、2023 CAGR 下降 `0.88pp`，未命中硬护栏；但 2026 CAGR `-4.37%`，改善幅度不足，判 `keep_watch`。
- window winner/robust/tracked 身份均未变，无 evict/archive。

### 本轮候选 ID 与命令

- 候选 `core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal28_leader80_coverage_penalty_risk06_cap04_exit74_signal_quality_v4`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-11 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal28_leader80_coverage_penalty_risk06_cap04_exit74_signal_quality_v4`；scorecard：`results/research/a_share/research_iteration_scorecard_20260914.json`。

### 下一轮 focus 与第一条命令

- focus 回到 `theme_risk_control`，将 risk-control-v5 与 capacity-v2 同窗对照，要求 2026 恢复非负且不牺牲 2020/2023。
- 第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-11 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal28_leader78_coverage_penalty_risk06_cap04_exit72_risk_control_v5,core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap04_exit72_capacity_v2`。

### Focus 候选池

- `theme_risk_control`：risk-control-v5、capacity-v2；`signal_quality`：signal-quality-v4、risk-control-v5。
- `capacity_and_overlap`：capacity-v2、signal-quality-v4；`low_turnover`：signal30/risk06 lowturn、signal29/risk04/cap05 lowturn。
...
- signal29/leader78 低换手形态未触发中窗硬护栏，留 `keep_watch`，但 2026 CAGR `-6.52%`；signal30 产生完全相同指标，作为无差异重复判 `reject`。既有 capacity-v2 仍是 `robust_observation`：进入观察位，不是强稳定 winner；正式身份不变。

### 本轮候选 ID 与命令

- `...signal29_leader78_coverage_penalty_risk06_cap05_exit68_lowturn`：2020/2023 CAGR 差分 `-0.03/+0.02pp`，2026 turnover `4.05x`，`keep_watch`。
- `...signal30_leader78_coverage_penalty_risk06_cap05_exit68_lowturn`：与 signal29 指标完全相同，`reject`。
...
- guard focus：`theme_signal_quality`。改验 prom24/signal31 与 capacity-v2，避免继续消耗在无差异 signal 阈值。
- 第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-09 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_90_10_total_mv_winner_core__aggr_13_87_prom24_emergent_theme_quality_gate_signal31_leader80_coverage_penalty_risk10_cap05_exit58_lowturn,core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap04_exit72_capacity_v2`。

### Focus 候选池

- `theme_signal_quality`：`...prom24...signal31_leader80...risk10_cap05_exit58_lowturn`；signal29 lowturn。
- `theme_capacity_cost` / `theme_risk_control`：capacity-v2；risk-control-v5。
...
- 上轮 exit68 容量变体三底座均 `reject` 并退出 active；90/10 total-mv capacity-v2 恢复为 Path4 robust 观察基准，但年内为负，不是强稳定 winner。

### 本轮候选 ID 与命令

- 90/10 total-mv `core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap04_exit72_capacity_v2`：`robust_observation`。2020 CAGR/MaxDD `2.35%/-16.53%`，2026 CAGR `-4.04%`；进入观察位，不是强稳定 winner。
- 80/20 total-mv `core_explore_80_20_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap04_exit72_capacity_v2`：`reject`。相对 90/10 参考，2020/2023 MaxDD 分别恶化 `12.28/14.60pp`，2026 CAGR `-13.69%`，主题收益提升不足以覆盖风险。
...
- guard focus：`emergent_theme_coverage`。下一轮比较 risk-control-v5 与 capacity-v2，优先检验 2026 修复是否会破坏 2020/2023 回撤；本轮未扩跑是 coverage blocker 降档。
- 第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-07 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal28_leader78_coverage_penalty_risk06_cap04_exit72_risk_control_v5,core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap04_exit72_capacity_v2`。

### Focus 候选池

- `emergent_theme_coverage` / `theme_signal_quality`：`core_explore_80_20_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal28_leader78_coverage_penalty_risk06_cap04_exit72_risk_control_v5`；`core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap04_exit72_capacity_v2`。
- `theme_risk_control`：`core_explore_80_20_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal28_leader78_coverage_penalty_risk06_cap04_exit72_risk_control_v5`；`core_explore_90_10_total_mv_winner_core__aggr_13_87_prom23_emergent_theme_quality_gate_signal29_leader78_coverage_penalty_risk04_cap05_exit70_lowturn`。
