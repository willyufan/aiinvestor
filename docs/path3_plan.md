...
- `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap40_hold8_turn02_exit98_risk08_weekly` 对 `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly`：`reject`；since_2020_01 CAGR差-10.52pp、MaxDD差-0.69pp、Sharpe差-0.40；since_2023_01 CAGR差-15.56pp、MaxDD差+23.76pp、Sharpe差-1.10；2026 CAGR +31.60%。触发中窗稳定性护栏：since_2020_01:cagr,since_2020_01:sharpe_ratio,since_2023_01:cagr,since_2023_01:sharpe_ratio
...
- 上轮 weekly_return_recovery_v6 因 2020/2023 CAGR 低于 cap52 robust 5.93/6.45pp 被 reject；本轮退出缓冲 v3 的五窗确认未改变既有窗口身份，停止此参数形态扩参、无 evict/archive。
- `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly` 对 `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly`：**reject**。since_2020_01: CAGR 14.46%（Δ+0.12pp）、MaxDD Δ+0.02pp、Sharpe Δ+0.01、换手 Δ-0.08x；since_2023_01: CAGR 7.79%（Δ-7.68pp）、MaxDD Δ+5.18pp、Sharpe Δ-0.29、换手 Δ-0.48x；since_2026_01: CAGR 11.28%（Δ+0.04pp）、MaxDD Δ+0.00pp、Sharpe Δ+0.00、换手 Δ+0.00x。周频退出缓冲预期降低换手和回撤，并守住2020/2023收益；2023 CAGR低7.68个百分点，换手只降0.48倍，收益稳定性不成立。
...
## 2026-09-20 迭代：周频退出缓冲待测

### 上一轮候选与结果摘要

- 上轮 v6 相对 cap52 的 2020/2023 CAGR 低 5.93/6.45pp，reject；cap52 仍为参照。本轮 Path2 coverage 先占 20 个四窗 ID，Path3 未新增回测、身份未变、无 evict/archive。

### 本轮候选 ID 与命令

- 已注册设计 `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly` 对 cap52，检验退出缓冲能否降低换手且不破坏中窗；预算被 blocking coverage 占用，未执行。

### 下一轮 focus 与第一条命令

- `turnover_reduction`；首命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-18 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：exit-buffer-v3、cap52；`weekly_exit_buffer`：exit-buffer-v3、cap54；`cost_stress`：cap46/turn04、cap52/turn04。纯周频 _weekly 与 Path1 月选股周仓位区分。

## 2026-09-19 迭代：v6 短窗反弹仍不能覆盖中窗失稳（端点 2026-09-18）

### 上一轮候选与结果摘要

- `weekly_return_recovery_v6_weekly` 相对 cap52 的 2020/2023 CAGR 下降 `5.93/6.45pp`，命中稳定性护栏；虽 2025/2026 CAGR 提高 `6.57/42.54pp`且换手下降，仍判 `reject`。cap52 incumbent 确认 `promote`，正式身份不变。
...
- 保持 `turnover_reduction`，停止 v6 同形；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-18 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：exit-buffer-v3、cap52；`weekly_exit_buffer`：exit-buffer-v3、cap54；`cost_stress`：cap46/turn04、cap52/turn04。

## 2026-09-18 迭代：低换手 v6 再次被中窗否决（端点 2026-09-17）

### 上一轮候选与结果摘要

- v6 年换手显著下降且 2025/2026 改善，但相对 cap52 的 2020/2023 CAGR 下降 `5.92/7.08pp`，命中护栏，判 `reject`；正式身份不变。

### 本轮候选 ID 与命令

- 候选 `...cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly`；参照 `...cap52_hold6_turn04_exit98_risk16_weekly`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-17 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly`。

### 下一轮 focus 与第一条命令

- 保持 `turnover_reduction`，但停止 v6 同形扩参；下一轮只做新端点确认，若中窗仍破坏则退出该支路。
- 第一条命令同上，端点随下一交易日推进。

### Focus 候选池

- `turnover_reduction`：v6-risk12、cap52-risk16；新候选必须先注册并明确改善 2020/2023 的机制。
...
- 上轮 turnover-repair 已 `reject`。本轮 cap46/hold7/turn02/exit99 相对 cap52 robust 虽显著降换手，但 2020/2023 CAGR 下降 `9.47/10.08pp`、Sharpe 下降 `0.370/0.212`，判 `reject`。2026 CAGR `30.37%` 不足以覆盖中窗失稳；正式身份不变。

### 本轮候选 ID 与命令

- 候选 `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn02_exit99_risk12_weekly`；参照 `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly`。
...
- guard focus 仍为 `weekly_exit_buffer`；停止 cap46/hold7/exit99 同形，改用 cap46/hold5/exit94 return-recovery 与 incumbent 对照。
- 第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-14 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly`。

### Focus 候选池

- `weekly_exit_buffer`：return-recovery-v7、cap52 incumbent；`turnover_reduction`：return-recovery-v6、v7。
- `risk_and_cost`：cap54/risk16、cap54/risk18；cap46/hold7/exit99 停止扩参。

## 2026-09-14 迭代：turnover-repair 改善短窗但中窗失守（端点 2026-09-11）

### 上一轮候选与结果摘要

- 上轮 exit90 降换手但破坏 2023 稳定性。本轮 `cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly` 将 2026 CAGR 提高到 `46.09%`、并降低多窗换手，但 2020/2023 CAGR 相对 robust 下降 `5.11/5.75pp`，命中两个中窗护栏，判 `reject`。
...
- focus 转向 `weekly_exit_buffer`，用 cap54 incumbent 与 cap46/turn02/exit99 对照，要求在保留换手优势的同时恢复 2020/2023 CAGR。
...
- `weekly_exit_buffer`：cap54/hold5/exit98、cap46/hold7/exit99；`turnover_reduction`：cap54 incumbent、cap46 turnover-repair。
- `risk_and_cost`：cap42/hold7/risk10 cost-stress、cap46/hold7/turn03/risk14 turnover-repair。
...
- 上轮 cap50/exit94 已淘汰；本轮 `...v7_weekly` 仅改善 2020，2023 CAGR 退化并触发护栏，判 `reject`。正式 cap52/risk16 robust 与 tracked 身份不变，无 evict/archive。

### 本轮候选 ID 与命令

- `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly`：`reject`；2020 CAGR 差分 `+1.40pp`，2023 `-6.39pp`，2026 CAGR `41.03%`、turnover `1.33x`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-08 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly`。

### 下一轮 focus 与第一条命令

- guard focus：`turnover_reduction`。回到 cap54/risk16 前沿与 cap46/hold7 turnover-repair，对 2023 收益设置硬约束。
- 第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-08 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly`。

### Focus 候选池

- `turnover_reduction`：`...cap54_hold5_turn05_exit98_risk16_weekly`；`...cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly`。
- `weekly_exit_buffer` / `risk_downshift`：`...cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly`；`...cap42_hold7_turn02_exit98_risk10_weekly`。
...
- 上轮 turnover-repair 因中窗收益与2026风险退化 `reject`，cap54 继续作为 Path3 robust 与 2020 window winner。

### 本轮候选 ID 与命令

- 五窗实跑 `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly` 与 `core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-04 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
- exit-buffer 相对 cap54 的 2020 CAGR低 `3.95pp`，触发二次稳定性护栏；虽 MaxDD 改善 `10.95pp`、换手降 `0.56x`，2026 CAGR仍从 `28.63%`转为 `-4.58%`，判 `reject`。它继续保留 2017 official window winner 身份，但不代表跨窗晋级。cap54 五窗确认 `promote` incumbent；robust/tracked ID 不变，无 evict/archive。

### 下一轮 focus 提示

- `turnover_reduction` 停止 exit-buffer-v3，转验 return-recovery v6/v7 是否能保住 2020/2023 收益。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-04 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly`。

### Focus 候选池

- `turnover_reduction`：v6-return-recovery、v4-turnover-reduction；`weekly_return_recovery`：v6、v7；`weekly_drawdown_control`：exit-buffer-v3、v4-turnover-reduction；`cost_stress`：cap54、v6。所有 Path3 候选均保持 `_weekly` 后缀。
...
- 上轮 cap44 虽降换手/回撤，却破坏 2020 与 2026，判 `reject`；cap54 继续为 `promote` incumbent。

### 本轮候选 ID 与命令

- 五窗实跑 `...cap52_hold6_turn04_exit98_risk16_weekly` 与 `...cap54_hold5_turn05_exit98_risk16_weekly`；命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-02 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
- cap52 相对 cap54 的 2020 CAGR 下降 `4.20pp`并触发护栏，虽 2023 CAGR高 `5.08pp`且换手低 `0.41x`，但 2026 从 `30.96%`降到 `-0.56%`，判 `reject`；cap54 五窗再确认 `promote`。无 winner/robust/tracked 变化及 evict/archive。

### 下一轮 focus 提示

- `turnover_reduction` 转验已注册 turnover-repair 形态；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-02 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap42_hold8_turn03_exit96_risk10_weekly_turnover_repair_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap42-turnover-repair、cap54 incumbent；`weekly_exit_buffer`：exit96-repair、exit98 incumbent；`risk_downshift`：cap42-risk10、cap40-risk08；`cost_stress`：cap42-cost-stress、cap54 incumbent。


## 2026-09-02 迭代：cap44 收益恢复以 2020 大幅退化为代价（端点 2026-09-01）

### 上一轮候选与结果摘要

- 上轮 cap46-turn02 虽降低换手和回撤，但 2020/2023 CAGR 退化而 `reject`；cap54 保持 incumbent。

### 本轮候选 ID 与命令

- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-01 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
- cap44 将 2020 turnover 降 `0.94x`、MaxDD改善 `10.81pp`，但 CAGR下降 `9.93pp`；2026 CAGR虽提高 `5.63pp`，MaxDD反而恶化 `12.46pp`，判 `reject`。cap54 五窗确认 `promote` incumbent；正式 winner/robust/tracked 未变，无 evict/archive。

### 下一轮 focus 提示

- `turnover_reduction` 停止 cap44-return 同形，确认已注册的 cap52/turn04 邻域；第一条可执行命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-09-01 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap52_hold6_turn04_exit98_risk16_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap52-turn04、cap54 incumbent；`weekly_exit_buffer`：exit96-v6、exit98 incumbent；`risk_downshift`：cap42-risk10、cap52-risk14；`cost_stress`：cap40-turn02、cap54 incumbent。
...
- `...cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly` 相对 cap54 incumbent 将 2020 MaxDD 改善 `10.23pp`、turnover 降约 `0.88x`，但 CAGR 下降 `9.71pp`，`reject`；`...cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly` 的 2020 CAGR 下降 `7.14pp`，同样 `reject`。
- cap54 incumbent 五窗口确认 `promote`，2020/2023/2026 CAGR `18.39%/9.31%/36.13%`。假设“risk14/cap46 能在减换手时守住中窗收益”不获支持；正式 winner/robust/tracked 未变，无 evict/archive。

### 本轮候选 ID 与命令

- 实跑 ID：`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-28 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### 下一轮 focus 提示

- `turnover_reduction`：停止 cap46/risk14 同形扩参，改测 exit-buffer 与更低 turnover threshold 是否能保留 2020 CAGR。第一条命令：`.venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn02_exit99_risk12_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：`...cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly`、`...cap46_hold7_turn02_exit99_risk12_weekly`。
- `return_recovery`：`...cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly`、`...cap52_hold5_turn05_exit98_risk16_weekly`。
- `weekly_drawdown_control`：`...cap42_hold6_turn04_exit96_risk12_weekly`、`...cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly`。

## 2026-08-29 迭代：中等换手修复仍未守住2020收益（端点 2026-08-28）

### 上一轮候选与结果摘要

- `turnover_repair_v3` 将2020 MaxDD改善 `10.32pp`，但CAGR下降 `6.25pp`，`reject`；`return_recovery_v6` 的2026 CAGR升至 `43.78%`、换手降至 `2.31x`，但2020 CAGR下降 `10.25pp`，仍触发护栏并 `reject`。
- cap54 五窗确认 `promote` incumbent，2020/2023/2026 CAGR为 `18.39%/9.31%/36.13%`。假设“中等换手 repair 可保住2020收益并改善短窗”只支持短窗，不能晋级；正式 winner/robust/tracked 未变，无 evict/archive。
...
- `turnover_reduction` 停止 cap44 同形，回到 cap46 的温和风险/退出边界，要求2020 CAGR损失收窄至3pp且 turnover 低于 cap54；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap46-turnover-repair、return-recovery-v7；`weekly_exit_buffer`：exit90-v3、exit97；`risk_downshift`：cap42-risk10、cap44-risk12；`cost_stress`：cap42-cost-stress、cap54。
...
- `exit_buffer_v3_weekly` 相对 cap54 将 2020/2023 MaxDD 改善 `10.95/15.04pp`、换手下降，但 2020 CAGR下降 `4.46pp`触发护栏，`reject`；`exit97_weekly` 回撤更浅、换手更低，但 2020/2023 CAGR下降 `15.15/7.78pp`，`reject`。cap54 同窗确认 `promote` incumbent，2026 CAGR `33.38%`。
- 假设“相邻 exit-buffer 能把收益损失压到3pp内”不获支持；正式 window winner/robust/tracked 未变，无 evict/archive。
...
- `turnover_reduction` 转验 risk10/risk08 的更长持有边界，要求 turnover 继续低于 cap54 且 2020/2023 CAGR 不触发 `-3pp` 护栏；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap42_hold7_turn02_exit98_risk10_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap40_hold8_turn02_exit98_risk08_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap42-risk10、cap40-risk08；`weekly_exit_buffer`：exit90-v3、exit97；`risk_downshift`：cap42-risk10、cap40-risk08；`cost_stress`：cap42-cost-stress、cap54。

## 2026-08-26 迭代：turnover-repair 与 return-recovery 再否定（端点 2026-08-25）

### 上一轮候选与结果摘要

- `cap46-turn03-risk14` 相对 cap54 锚将 2020 turnover 降低 `0.87x`、MaxDD 改善 `10.23pp`，但 CAGR 下降 `9.56pp`；`cap44-return-v6` 将 turnover 降低 `0.93x`、MaxDD 改善 `18.81pp`，但 CAGR 下降 `11.38pp` 且 2026 CAGR `-3.71%`，两者均触发稳定性护栏并 `reject`。
- `cap54...weekly` 五窗口确认 `promote` incumbent，2020/2023/2026 CAGR 为 `17.80/8.56/33.26%`。假设“温和减换手可保住中窗收益”再次不获支持；正式 winner/robust 未变，所有候选 ID 以 `_weekly` 结尾，无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260826.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly`、`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-25 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### 下一轮 focus 提示

- rotation=`weekly_exit_buffer`，停止继续下压 cap，改验 exit90/97 的相邻缓冲能否在 turnover 不超过 cap54 的同时把 2020 CAGR 损失收窄至 3pp 内；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit97_risk12_weekly_exit_buffer_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `weekly_exit_buffer`：exit-buffer-v3、exit97-buffer；`turnover_reduction`：cap46-turn03、cap44-return-v6；`risk_downshift`：cap40-risk08、cap42-risk10；`cost_stress`：cap42-cost-stress、cap54。

## 2026-08-25 迭代：cap44 减换手边界再否定（端点 2026-08-24）

### 上一轮候选与结果摘要

- `cap44-turn03-risk10` 将2020换手降低约 `0.95x`、MaxDD改善 `9.55pp`，但 CAGR下降 `10.55pp`；`cap44-turn04-risk12-v3` 将2020换手降低 `0.54x`，但 CAGR下降 `6.56pp`，两者均触发稳定性护栏并 `reject`。假设“cap44可降低换手且守住中窗收益”不获支持。
- `cap54...weekly` 五窗确认 `promote` incumbent，2020/2023/2026 CAGR为 `17.90/8.70/35.06%`；正式 Path3 winner/robust 未变，所有 ID 以 `_weekly` 结尾，无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260825.json`。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold8_turn03_exit96_risk10_weekly_turnover_repair_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold7_turn04_exit94_risk12_weekly_turnover_repair_v3_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
...
- `turnover_reduction` 停止 cap44 同形，回测 cap46 的温和 turn/exit 组合并继续与 cap54 锚比较；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap46-turn03、cap44-return-v6；`weekly_exit_buffer`：exit-buffer-v3、return-recovery-v6；`risk_downshift`：cap40-risk08、cap42-risk10；`cost_stress`：cap42-cost-stress、cap54。

## 2026-08-24 迭代：减换手与中窗收益不可兼得再确认（端点 2026-08-21）

### 上一轮候选与结果摘要

- `turnover_repair` 将 2020 turnover 降低约 `0.88x`、MaxDD改善 `10.23pp`，但 CAGR下降 `9.89pp`；`return_recovery_v7` 的 2020 CAGR也下降 `7.33pp`，两者触发护栏并 `reject`。假设“中等仓位/持有期可降低换手且守住2020收益”再次不获支持。
- `cap54...weekly` 五窗确认 `promote` incumbent；2017/2020/2023 winner 与 robust 主体未变，所有候选 ID 以 `_weekly` 结尾，无 evict/archive。完整卡见 `results/research/a_share/research_iteration_scorecard_20260824.json`。
...
- `turnover_reduction` 转验 cap44 的相邻 turn/exit 组合，不再继续降低到 cap30/40；下一轮第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold8_turn03_exit96_risk10_weekly_turnover_repair_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold7_turn04_exit94_risk12_weekly_turnover_repair_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap44-turn3、cap44-turn4-v3；`weekly_exit_buffer`：exit-buffer-v3、exit97-buffer；`risk_downshift`：cap40-risk08、cap42-risk10；`cost_stress`：cap42-cost-stress、cap54。

## 2026-08-23 迭代：极低风险减换手边界确认（端点 2026-08-21）

### 上一轮候选与结果摘要

- `turnover_reduction_v4` 相对 cap54 的 2020/2023 CAGR下降 `16.61/11.10pp`、Sharpe下降 `0.499/1.140`；`cap30-hold11-risk06` 的 2020/2023 CAGR下降 `16.81/7.61pp`，均触发稳定性护栏并 `reject`。
- `cap54...weekly` 五窗确认 `promote` incumbent；2017/2020/2023 winner 与 robust 继续保持，全部 ID 以 `_weekly` 结尾，无 evict/archive。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap40_hold9_turn02_exit96_risk08_weekly_turnover_reduction_v4_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap30_hold11_turn02_exit98_risk06_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-21 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap40_hold9_turn02_exit96_risk08_weekly_turnover_reduction_v4_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap30_hold11_turn02_exit98_risk06_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### 下一轮 focus 提示

- `turnover_reduction` 停止继续压低 risk/cap，转回中等仓位 exit/return-recovery 相邻边界；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap46-turnover-repair、cap54；`weekly_exit_buffer`：exit-buffer-v3、return-recovery-v7；`risk_downshift`：cap40-risk08、cap30-risk06；`cost_stress`：cap42-cost-stress、cap54。
...
- `cap46/risk14 turnover-repair` 把 2026 turnover 控制在 `2.36x` 且 2023 CAGR改善 `0.78pp`，但 2020 CAGR下降 `9.66pp`；`cap42/risk10 cost-stress` 的 2020/2023 CAGR下降 `13.96/5.24pp`，两者均触发稳定性护栏并 `reject`。假设“中等仓位可在保留中窗收益下减换手”不成立。
- cap54 五窗同窗确认 `promote` incumbent，2026 CAGR/MaxDD/turnover 为 `37.70%/-21.48%/1.71x`；正式 winner/robust/tracked 未变，无 evict/archive。全部 ID 以 `_weekly` 结尾。
...
- `turnover_reduction` 连续损失 2020 收益，下一轮只确认 exit-buffer 的相邻边界，不再降低 risk/cap；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn02_exit99_risk12_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：exit-buffer-v3、cap54；`weekly_exit_buffer`：exit-buffer-v3、cap46-exit99；`risk_downshift`：cap42-risk10、cap40-risk08（仅历史边界）；`cost_stress`：cap42-cost-stress、cap54。
...
- `cap46_hold7_turn02` 相对 cap54 的 2020 CAGR/Sharpe下降 `14.61pp/0.400`，`exit_buffer_v3_weekly` 的 2020/2023 CAGR下降 `4.61/3.09pp`，两者均触发稳定性护栏并判 `reject`；低换手或回撤改善不足以抵消中窗收益损失。cap54 同窗确认 `promote` incumbent，2026 CAGR `47.93%`、MaxDD `-21.48%`、turnover `1.72x`。Path3 正式 2017 winner 已在 `HEAD` 中是 exit-buffer-v3，本轮无新增 artifact 变化；robust 仍为 cap54，无 evict/archive。

### 本轮候选 ID 与命令

- IDs：`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn02_exit99_risk12_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly`、`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。
- 命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --end-date 2026-08-18 --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn02_exit99_risk12_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### 下一轮 focus 提示

- `weekly_exit_buffer` 已连续破坏中窗，下一轮转 `risk_downshift`，要求 turnover 不高于 cap54 且 2020/2023 CAGR不触发 `-3pp` 护栏；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap42_hold7_turn02_exit98_risk10_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap40_hold8_turn02_exit98_risk08_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap42-risk10、cap40-risk08；`weekly_exit_buffer`：exit-buffer-v3、cap54；`risk_downshift`：cap42-risk10、cap40-risk08；`cost_stress`：cap42-cost-stress、cap54。
...
- `return_recovery_v6` 相对 cap54 将 2020 MaxDD改善 `18.97pp`、turnover下降 `0.94x`，但 CAGR下降 `11.61pp` 且 2026 CAGR仅 `1.06%`，`reject`；`v7` 的 2020 CAGR下降 `7.13pp`，虽 2026 CAGR `24.63%`、MaxDD改善 `9.58pp`，仍破坏中窗稳定性，`reject`。cap54 五窗同窗 `promote` incumbent；全部 ID 以 `_weekly` 结尾，正式 winner/robust/tracked 未变，无 evict/archive。
...
- `turnover_reduction` 停止 v6/v7 同形恢复，转查 exit-buffer 与中换手锚；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn02_exit99_risk12_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold6_turn04_exit90_risk12_weekly_exit_buffer_v3_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap46-turn02、exit-buffer-v3；`weekly_exit_buffer`：exit-buffer-v3、cap54；`risk_downshift`：cap42-risk10、cap46-risk14；`cost_stress`：cap42-cost-stress、cap54。

## 2026-08-15 迭代：周频换手中间带确认（端点 2026-08-14）

### 上一轮候选与结果摘要

- `cap46/turn03` 相对 cap54 将 2020 MaxDD改善 `10.39pp`、turnover 降约 `0.97x`，但 CAGR下降 `9.80pp`，`reject`；`cap50/turn04` 的 2020 CAGR下降 `4.66pp`、2026 CAGR仅 `5.04%`，`reject`。假设“中间仓位可在保收益下减换手”不成立。
- `cap54` 以 2020/2023/2026 CAGR `18.50%/9.70%/44.46%` 同窗确认 `promote` incumbent；Path3 robust/tracked 不变，全部策略 ID 均以 `_weekly` 结尾，无 evict/archive。scorecard：`results/research/a_share/research_iteration_scorecard_20260815.json`。
...
- `turnover_reduction` 停止 cap46/cap50 同形扩参，改查 return-recovery 是否能恢复 2020 且保持低换手；第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap44_hold6_turn03_exit96_risk12_weekly_return_recovery_v6_weekly,core_explore_80_20_total_mv_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold5_turn04_exit94_risk14_weekly_return_recovery_v7_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：return-recovery-v6、return-recovery-v7；`weekly_exit_buffer`：exit-buffer-v3、cap54；`risk_downshift`：cap42-risk10、cap46-risk14；`cost_stress`：cap42-cost-stress、cap54。

## 2026-08-14 迭代：周频风险降档确认（端点 2026-08-13）

### 上一轮候选与结果摘要

- cap42/risk10 与 cap40/risk08 将 2020 MaxDD 相对 cap54 分别改善 `10.73/10.39pp`，换手降到 `0.42/0.37x`，但 2020 CAGR 分别下降 `13.79/14.37pp`，均触发 CAGR/Sharpe 护栏并判定 `reject`；假设“风险降档能在保收益下减换手”不成立。
- cap54 incumbent 的 2020/2023/2026 CAGR 为 `17.86%/9.08%/40.12%`，同窗 `promote`。全部 ID 以 `_weekly` 结尾，正式 winner/robust/tracked 未变，无 evict/archive。scorecard：`results/research/a_share/research_iteration_scorecard_20260814.json`。
...
- `turnover_reduction` 停止 cap40/42 过度降档，回到 cap46 收益恢复中间带。第一条命令：`AIINVESTOR_FORCE_OFFLINE=1 .venv/bin/python backtest_marketcap_etf.py --sample-tags since_2017_01,since_2020_01,since_2023_01,since_2025_01,since_2026_01 --only-base-ids core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap46_hold7_turn03_exit98_risk14_turnover_repair_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap50_hold6_turn04_exit98_risk16_weekly,core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cost_guard_cap54_hold5_turn05_exit98_risk16_weekly`。

### Focus 候选池

- `turnover_reduction`：cap46-turn03、cap50；`weekly_exit_buffer`：exit-buffer-v3、cap54；`risk_downshift`：cap42-risk10、cap46-risk14；`cost_stress`：cap42-cost-stress、cap54。
