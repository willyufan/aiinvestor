...
- `2017-01-01` → `2026-04-19`: CAGR `18.19%`, Max DD `-13.20%`, Sharpe `0.9975`
...
- `2025-01-01` → `2026-04-19`: CAGR `68.33%`, Max DD `-11.71%`, Sharpe `1.7160`
...
- 策略：`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cash_off`（核心80_探索20_等权底座_胜出者核心__进攻8/92 晋升6只(熊市空仓)）
- 加权指标（CAGR / Sharpe / Max DD / Turnover）：`108.23%` / `2.5481` / `-8.11%` / `4.96`

窗口指标（截至 `2026-04-19`，权重：2025-01=100%）：

- `2017-01-01` → `2026-04-19`: CAGR `23.46%`, Max DD `-24.37%`, Sharpe `0.9750`
- `2020-01-01` → `2026-04-19`: CAGR `23.46%`, Max DD `-24.37%`, Sharpe `0.9750`
- `2023-01-01` → `2026-04-19`: CAGR `28.21%`, Max DD `-11.30%`, Sharpe `1.1717`
- `2025-01-01` → `2026-04-19`: CAGR `108.23%`, Max DD `-8.11%`, Sharpe `2.5481`
...
- 策略：`core_explore_80_20_equal_weight_winner_core__aggr_08_92_prom6_cash_off`（核心80_探索20_等权底座_胜出者核心__进攻8/92 晋升6只(熊市空仓)）
- 鲁棒指标（平均 CAGR / 最低 CAGR / 平均 Sharpe / 最差 Max DD / 平均 Turnover）：`45.84%` / `23.46%` / `1.4174` / `-24.37%` / `3.12`
