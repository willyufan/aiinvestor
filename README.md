...
- 加权指标（CAGR / Sharpe / Max DD / Turnover）：`97.83%` / `2.2946` / `-9.54%` / `1.39`

窗口指标（截至 `2026-04-26`，权重：2025-01=100%）：

- `2017-01-01` → `2026-04-26`: Total Return `323.24%`, CAGR `16.72%`, Max DD `-44.24%`, Sharpe `0.7446`, Turnover `0.97`
- `2020-01-01` → `2026-04-26`: Total Return `210.71%`, CAGR `19.60%`, Max DD `-41.75%`, Sharpe `0.7489`, Turnover `1.00`
- `2023-01-01` → `2026-04-26`: Total Return `121.78%`, CAGR `26.99%`, Max DD `-36.71%`, Sharpe `0.9430`, Turnover `1.07`
- `2025-01-01` → `2026-04-26`: Total Return `148.35%`, CAGR `97.83%`, Max DD `-9.54%`, Sharpe `2.2946`, Turnover `1.39`
- `2026-01-01` → `2026-04-26`: Total Return `20.02%`, CAGR `72.88%`, Max DD `0.00%`, Sharpe `3.3222`, Turnover `1.36`
...
- 鲁棒指标（平均 CAGR / 最低 CAGR / 平均 Sharpe / 最差 Max DD / 平均 Turnover）：`45.32%` / `26.20%` / `1.1841` / `-31.84%` / `0.96`

窗口指标：

- `2017-01-01` → `2026-04-26`: Total Return `837.21%`, CAGR `27.09%`, Max DD `-25.40%`, Sharpe `1.0329`, Turnover `0.88`
- `2020-01-01` → `2026-04-26`: Total Return `336.54%`, CAGR `26.20%`, Max DD `-23.89%`, Sharpe `0.9092`, Turnover `0.86`
- `2023-01-01` → `2026-04-26`: Total Return `124.89%`, CAGR `27.52%`, Max DD `-31.84%`, Sharpe `0.8405`, Turnover `0.95`
- `2025-01-01` → `2026-04-26`: Total Return `152.77%`, CAGR `100.47%`, Max DD `-10.61%`, Sharpe `1.9537`, Turnover `1.16`
- `2026-01-01` → `2026-04-26`: Total Return `35.49%`, CAGR `148.75%`, Max DD `-2.78%`, Sharpe `3.0648`, Turnover `1.00`
...
- 加权指标（CAGR / Sharpe / Max DD / Turnover）：`28.09%` / `1.0061` / `-46.94%` / `3.89`

窗口指标（截至 `2026-04-26`，权重：2017-01=100%）：

- `2017-01-01` → `2026-04-26`: Total Return `907.70%`, CAGR `28.09%`, Max DD `-46.94%`, Sharpe `1.0061`, Turnover `3.89`
- `2020-01-01` → `2026-04-26`: Total Return `338.27%`, CAGR `26.28%`, Max DD `-54.29%`, Sharpe `0.8521`, Turnover `4.52`
- `2023-01-01` → `2026-04-26`: Total Return `142.54%`, CAGR `30.45%`, Max DD `-31.88%`, Sharpe `1.0791`, Turnover `4.28`
- `2025-01-01` → `2026-04-26`: Total Return `169.08%`, CAGR `110.09%`, Max DD `-12.41%`, Sharpe `1.9735`, Turnover `6.55`
- `2026-01-01` → `2026-04-26`: Total Return `28.00%`, CAGR `109.73%`, Max DD `0.00%`, Sharpe `4.4355`, Turnover `4.84`
...
- 加权指标（CAGR / Sharpe / Max DD / Turnover）：`55.97%` / `1.1684` / `-50.82%` / `5.32`

窗口指标（截至 `2026-04-26`，权重：2023-01=100%）：

- `2017-01-01` → `2026-04-26`: Total Return `379.81%`, CAGR `18.30%`, Max DD `-68.09%`, Sharpe `0.6566`, Turnover `5.01`
- `2020-01-01` → `2026-04-26`: Total Return `309.79%`, CAGR `24.95%`, Max DD `-68.64%`, Sharpe `0.6844`, Turnover `5.95`
- `2023-01-01` → `2026-04-26`: Total Return `340.03%`, CAGR `55.97%`, Max DD `-50.82%`, Sharpe `1.1684`, Turnover `5.32`
- `2025-01-01` → `2026-04-26`: Total Return `179.64%`, CAGR `116.25%`, Max DD `-14.79%`, Sharpe `1.9741`, Turnover `6.29`
- `2026-01-01` → `2026-04-26`: Total Return `41.34%`, CAGR `182.33%`, Max DD `0.00%`, Sharpe `4.2082`, Turnover `4.09`
...
- 鲁棒指标（平均 CAGR / 最低 CAGR / 平均 Sharpe / 最差 Max DD / 平均 Turnover）：`57.28%` / `17.11%` / `1.1413` / `-66.07%` / `5.56`

窗口指标：

- `2017-01-01` → `2026-04-26`: Total Return `336.90%`, CAGR `17.11%`, Max DD `-65.24%`, Sharpe `0.6296`, Turnover `5.16`
- `2020-01-01` → `2026-04-26`: Total Return `221.81%`, CAGR `20.27%`, Max DD `-66.07%`, Sharpe `0.6042`, Turnover `5.66`
- `2023-01-01` → `2026-04-26`: Total Return `297.84%`, CAGR `51.33%`, Max DD `-49.35%`, Sharpe `1.1891`, Turnover `5.43`
- `2025-01-01` → `2026-04-26`: Total Return `222.04%`, CAGR `140.40%`, Max DD `-17.33%`, Sharpe `2.1422`, Turnover `5.98`
- `2026-01-01` → `2026-04-26`: Total Return `43.87%`, CAGR `197.81%`, Max DD `0.00%`, Sharpe `4.0216`, Turnover `4.65`
