...
- `2020-01-01` → `2026-04-24`: Total Return `327.42%`, CAGR `25.78%`, Max DD `-21.59%`, Sharpe `0.9271`, Turnover `0.67`
...
- `2020-01-01` → `2026-04-24`: Total Return `222.94%`, CAGR `20.33%`, Max DD `-41.75%`, Sharpe `0.7626`, Turnover `1.00`
...
- `2020-01-01` → `2026-04-24`: Total Return `354.68%`, CAGR `27.01%`, Max DD `-23.89%`, Sharpe `0.9116`, Turnover `0.86`
...
- `2020-01-01` → `2026-04-24`: Total Return `239.88%`, CAGR `21.31%`, Max DD `-66.07%`, Sharpe `0.6184`, Turnover `5.66`
