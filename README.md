...
- 鲁棒指标（平均 CAGR / 最低 CAGR / 平均 Sharpe / 最差 Max DD / 平均 Turnover）：`25.96%` / `9.23%` / `1.0791` / `-16.67%` / `5.20`

窗口指标：

- `2017-01-01` → `2026-06-26`: Total Return `156.16%`, CAGR `10.41%`, Max DD `-16.67%`, Sharpe `0.7400`, Turnover `3.86`
