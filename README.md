...
- `2017-01-01` → `2026-04-27`: Total Return `500.19%`, CAGR `21.17%`, Max DD `-23.49%`, Sharpe `0.8949`, Turnover `0.66`
- `2020-01-01` → `2026-04-27`: Total Return `319.24%`, CAGR `25.40%`, Max DD `-21.59%`, Sharpe `0.9235`, Turnover `0.67`
- `2023-01-01` → `2026-04-27`: Total Return `118.79%`, CAGR `26.48%`, Max DD `-27.62%`, Sharpe `0.8629`, Turnover `0.69`
- `2025-01-01` → `2026-04-27`: Total Return `140.67%`, CAGR `93.23%`, Max DD `-10.10%`, Sharpe `1.9482`, Turnover `1.05`
- `2026-01-01` → `2026-04-27`: Total Return `29.68%`, CAGR `118.09%`, Max DD `-3.61%`, Sharpe `3.0961`, Turnover `0.83`
...
- `2017-01-01` → `2026-04-27`: Total Return `936.91%`, CAGR `28.48%`, Max DD `-46.94%`, Sharpe `1.0116`, Turnover `3.89`
- `2020-01-01` → `2026-04-27`: Total Return `351.04%`, CAGR `26.85%`, Max DD `-54.29%`, Sharpe `0.8614`, Turnover `4.52`
- `2023-01-01` → `2026-04-27`: Total Return `151.85%`, CAGR `31.93%`, Max DD `-31.88%`, Sharpe `1.0972`, Turnover `4.28`
- `2025-01-01` → `2026-04-27`: Total Return `176.85%`, CAGR `114.63%`, Max DD `-12.41%`, Sharpe `1.9988`, Turnover `6.55`
- `2026-01-01` → `2026-04-27`: Total Return `31.70%`, CAGR `128.43%`, Max DD `0.00%`, Sharpe `4.4107`, Turnover `4.84`
...
- `2017-01-01` → `2026-04-27`: Total Return `399.05%`, CAGR `18.80%`, Max DD `-68.09%`, Sharpe `0.6650`, Turnover `5.01`
- `2020-01-01` → `2026-04-27`: Total Return `334.38%`, CAGR `26.10%`, Max DD `-68.64%`, Sharpe `0.6988`, Turnover `5.95`
- `2023-01-01` → `2026-04-27`: Total Return `359.72%`, CAGR `58.03%`, Max DD `-50.82%`, Sharpe `1.1874`, Turnover `5.32`
- `2025-01-01` → `2026-04-27`: Total Return `196.18%`, CAGR `125.77%`, Max DD `-14.79%`, Sharpe `1.9583`, Turnover `6.29`
- `2026-01-01` → `2026-04-27`: Total Return `49.70%`, CAGR `235.45%`, Max DD `0.00%`, Sharpe `3.7777`, Turnover `4.09`
...
- 鲁棒指标（平均 CAGR / 最低 CAGR / 平均 Sharpe / 最差 Max DD / 平均 Turnover）：`58.51%` / `17.57%` / `1.1406` / `-66.07%` / `5.56`

窗口指标：

- `2017-01-01` → `2026-04-27`: Total Return `353.09%`, CAGR `17.57%`, Max DD `-65.24%`, Sharpe `0.6373`, Turnover `5.16`
- `2020-01-01` → `2026-04-27`: Total Return `214.41%`, CAGR `19.83%`, Max DD `-66.07%`, Sharpe `0.5976`, Turnover `5.66`
- `2023-01-01` → `2026-04-27`: Total Return `305.89%`, CAGR `52.24%`, Max DD `-49.35%`, Sharpe `1.1933`, Turnover `5.43`
- `2025-01-01` → `2026-04-27`: Total Return `229.22%`, CAGR `144.41%`, Max DD `-17.33%`, Sharpe `2.1342`, Turnover `5.98`
